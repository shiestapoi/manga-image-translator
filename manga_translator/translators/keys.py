...
# deepl
DEEPL_AUTH_KEY = os.getenv('DEEPL_AUTH_KEY', 'e31fe7d5-6315-43f8-a084-6f17898de3ee:fx') #YOUR_AUTH_KEY
# openai
...
# Gemini
GEMINI_API_KEY = os.getenv('GEMINI_API_KEY', 'AIzaSyBvoysS6exzwVYDA1uSY8ESYJ4eQ16L8Z8')
GEMINI_MODEL = os.getenv('GEMINI_MODEL', 'gemini-1.5-flash-002')


# deepseek
DEEPSEEK_API_KEY = os.getenv('DEEPSEEK_API_KEY', 'sk-2e6b8d7586f34453a7cc568ba633d2d8')
