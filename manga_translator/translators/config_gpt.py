...
class ConfigGPT:
    ...
    _CHAT_SAMPLE = {
        ...
        'Indonesian': [
            ...
            (
            '<|1|>Malu sekali... Aku tidak ingin menonjol... Aku ingin menghilang...\n'
            '<|2|>Kamu... baik-baik saja?!\n'
            '<|3|>Apa yang salah dengan orang ini? Tidak bisa membaca situasi...?\n'
            )
        ],
    }
    ...
    _JSON_SAMPLE = {
        ...
        'Indonesian': [
            ...
            TranslationList(
            TextList=[
                TextValue(ID=1, text="Malu sekali... Aku tidak ingin menonjol... Aku ingin menghilang..."),
                TextValue(ID=2, text="Kamu... baik-baik saja?!"),
                TextValue(ID=3, text="Apa yang salah dengan orang ini? Tidak bisa membaca situasi...?")
            ]
            )
        ]
    }
    ...
    _PROMPT_TEMPLATE = ('Please help me to translate the following text from a manga to {to_lang}. '
                        'Make the translation casual and suitable for manga dialogue. '
